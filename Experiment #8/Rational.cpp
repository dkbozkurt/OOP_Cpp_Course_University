...
Rational Rational::operator-(const Rational& s){
    Rational temp1;
    temp1.num=(*this).num*s.den-(*this).den*s.num;
    temp1.den=(*this).den*s.den;
    return temp1;

}
Rational Rational::operator*(const Rational& m){
    Rational temp2;
    temp2.num=(*this).num*m.num;
    temp2.den=(*this).den*m.den;
    return temp2;

}
Rational Rational::operator/(const Rational& d){
    Rational temp3;
    temp3.num=(*this).num*d.den;
    temp3.den=(*this).den*d.num;
    return temp3;
